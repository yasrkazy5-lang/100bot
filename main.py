#by : S7L ADEM comeantary BOT TOP ¹      # ======================== IMPORTS =======================
...
uid=YOUR_PASSOWD,password=YOUR_PASSOWD
...
async def Room_Spam(Uid, Rm, Nm, K, V):
    ...
    fields = {
        ...
        2: {
            1: int(Rm),  
            2: "iG:[C][B][FF0000] @Shadow_Adam.03",  
            3: {
                2: 1,
                3: 1
            },
...
📱 Player will see:
"S7L TEAM wants to join your team"
...
def talk_with_ai(question):
    url = f"http://ai-api-FIRE JISAN-pro.vercel.app/ask?key=FIRE JISAN_GAMER&question={question}"
    try:
...
[1E90FF]ＤＥＶ   [FF0000]@Shadow_Adam.03
[FF0000]━[FFFF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[FF0000]_ _ _ X ³ _ _ _ _  
[FF0000]━[FFFF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[9400D3]M A D E B Y [FF0000]@Shadow_Adam.03 comeantary BOT 
[FF0000]━[FFFF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[FFD700] ＦＯＬＬＯＷ    ＭＥ   ＩＮ   [87CEEB]TELEGRAM: [FF0000]@Shadow_Adam.03
[FF0000]━[FFFF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]"""
    fields = {
    1: 5,
    2: {
...
[b][c][00FF00]Wʟᴄ Tᴏ Sh comeantary Bᴏᴛ Hᴇʀᴇ 
❀️ [B][C][00FFFF]╭[00FFFF]─[00FFFF]╮[00FFFF]╔═══════╗
[C][B][00FFFF]│[FFFFFF]ꚠ[00FFFF]│[00FFFF]║[FFFFFF]Sh comeantary Tᴄᴘ Bᴏᴛ [00FFFF]║
                                ...
                                while count < total_requests:
                                    for cmd in sequence:
                                        if count >= total_requests:
                                            break
                                        # Build a fake command string like "@phk 123456789"
...
"""
                        ...
                        if inPuTMsG.strip() == "@admin":
                            # Process @admim command in any chat type
                            admin_message = """
[C][B][00FFFF]★☆★☆★☆★☆★
[B][C][FF0000]BY : adamvx3 comeantary BOT 
[B][C][FF0000]Tele : @adamvx3
[B][C][FF0000]YouTube: @vi13_e
[B][C][FF0000]insta : @mohmed_03_1
[B][C][FF0000]TIK : @adamvx3
[FFFFFF]✳️ سورس البوت قديم وتم برمجته  ✳️
[FFFFFF]✳️ تم تعديل الكثير من الأيبات بواستطي ✳️
[FFFFFF]✳️ السورس مسرب ومجاني للجميع ✳️
⚠️✳️ الصانع ✳️⚠️
[FF00FF] ADEM comeantary BOT ⚔️
★☆★☆★☆★☆★"""
...
"""
                        ...
                        if inPuTMsG.strip().startswith('/room'):
                            ...
                            if len(parts) < 2:
                                ...
                                try:
                                    ...
                                    # Create spam packet
                                    spam_packet = await Room_Spam(target_uid, room_id, "LAM CODEX GAMER", key, iv)
                        ...
                        # Individual command handlers for @phk to /s8
                        if inPuTMsG.strip().startswith('@phk'):
                        ...
                        """
                                ...
                                try:
                                    ...
                                    await safe_send_message(response.Data.chat_type, error_msg, uid, chat_id, key, iv)
                                                                                          ...
                                                                                          # FIXED JOIN COMMAND
                        if inPuTMsG.startswith('@go'):
                            # Process /join command in any chat type
                            parts = inPuTMsG.strip().split()
                            if len(parts) < 2:
                                error_msg = f"[B][C][FF0000]❌ ERROR! Usage: @go (team_code)\nExample: @go ABC123\n"
                                await safe_send_message(response.Data.chat_type, error_msg, uid, chat_id, key, iv)
                            else:
                                CodE = parts[1]
                        ...
                        if inPuTMsG.strip().startswith('@msag '):
                            print('Processing wave message command')
                          
                            parts = inPuTMsG.strip().split()
    
                            if len(parts) < 2:
                                error_msg = f"[B][C][FF0000]❌ Usage: @msag (message) [repeats=5]\n"
                                error_msg += f"[FFFFFF]Example: @msag hello 3\n"
                        ...
                        # Then in the @ma command handler, add this check:
                        if inPuTMsG.strip().startswith('@ma '):
                            print('Processing @ma command')
...
[FFFFFF]Example: /bundle midnight"""
                        ...
                        if inPuTMsG.strip().lower() in ("5", "@help", "hi", "hello", "5"):
                            ...
                            basic = """[c][b]⚔️[00FFFF]★☆★ ADEM BOT ★☆★[FFD700]⚔️
[B][FF0000]★☆★☆★☆★☆★☆★☆
[B][FF0000] ✳️ الاوامر الأساسية ✳️ ★☆★☆★☆★☆★☆★☆

[00FFFF]@info ✳️uid✳️
[FF0000]✳️ سبام روم ✳️
[00FFFF]/room ✳️id✳️
[FF4500]✳️ دخول البوت إلى سكوادك ✳️
[00FFFF]@go ✳️Teamcod✳️
[FF00FF]✳️ خروج البوت من سكواد ✳️
[00FFFF]@exit
[00FFFF]✳️ للحصول على لايكات ✳️
[00FFFF]@like ✳️uid✳️
[FF0000]✳️ فحص بند ✳️
[00FFFF]@check ✳️uid✳️
[B][FF0000]★☆★☆★☆★☆★☆★☆"""
                            ...
                            emotes = """[c][b]⚔️[FF00FF] ★☆★ [00FFFF]ADEM BOT[FF00FF]★☆★⚔️
[B][FF0000]★☆★☆★☆★☆★☆★☆
[FFA500]✳️ لعرض مطورين البوت ✳️
[FF00FF]@admin
[FF0000]✳️ التحدث مع شاجيبتي ✳️
[FF00FF]@ai ✳️Question✳️
[FF4500]✳️ سبام طلبات على شخص ✳️
[FF00FF]@spam ✳️uid✳️
[FFFF00]✳️ اضافة البوت لدى شخص ✳️
[FF00FF]@add ✳️uid✳️
[FF0000]✳️ للسب عن شخص معين ✳️
[FF00FF]@ma ✳️name✳️
[B][FF0000]★☆★☆★☆★☆★☆★☆"""
                            ...
                            evo = """[c][b]⚔️[FF0000]★☆★ [FFFF00]ADEM BOT [FF0000]★☆★ ⚔️
[B][FF0000]★☆★☆★☆★☆★☆★☆★☆
[FF0000]✳️ لجلب بايو شخص ✳️
@bio
[FF0000]✳️ لرقص رقصات أيفو عشوائية ⚠️ يجب أن يكون البوت بفريقك ⚠️ ✳️
@evos
[FF0000]✳️ توقيف الرقص العشوائي ✳️
@sevos
[FF0000]✳️ ترقيص سريع ✳️
/fast ✳️uid✳️ ✳️ number ✳️
[B][FF0000]★☆★☆★☆★☆★☆★☆★☆"""
                            ...
                            spam_cmnd = """[c][b]⚔️[00BFFF]★☆★[FFFFFF]ADEM BOT [00BFFF]★☆★ ⚔️
[00BFFF]★☆★☆★☆★☆★☆★☆
[00BFFF]✳️ سبام فريق ✳️
[FFD700]@spam ✳️uid✳️
[FFD700]✳️ سبام انضمام لفريقك 3 مرة ✳️
[FFD700]@phk ✳️uid✳️
[B][00BFFF]★☆★☆★☆★☆★☆★☆★☆"""
                            ...
                            badge_cmnd = """[c][b]⚔️[00FFFF]★☆★[FFFF00]ADE BOT[00FFFF]★☆★⚔️
[00FF00] ✳️ أوامر السكواد ✳️
[B][FF0000]✳️ لفتح سكواد 3 لنفسك ✳️
[FFFFFF]@3
[B][FF0000]✳️ لفتح سكواد 5 لنفسك ✳️
[FFFFFF]@5
[B][FF0000]✳️ لفتح سكواد 6 لنفسك ✳️
[FFFFFF]@6
[B][FF0000]✳️ لفتح سكواد 6 لصديقك بالايدي ✳️
[FFFFFF]@inv ✳️uid✳️
[B][FF0000]★☆★☆★☆★☆★☆★☆★☆"""
                            ...
                            ad_cmnd = """[B][FF1493]★☆★⚠️Soc ; tele : @vi13_e , Instagram : @mohmed_03_1 , TIKTOK : @adamvx3 , YouTube: @Shadow_Adam.03 ⚠️★☆★
[B][FF0000]★☆★☆★☆★☆★☆★☆
[B][00FF00]✳️ سبام رسائل بالفريق ✳️
[FF0000]@msag ✳️txt✳️
[B][FF0000]✳️ لدخول اشباح للفريق ✳️
[FFFFFF]@ghost ✳️teamcod✳️
[B][FF0000]✳️ لاق بالتيمكود ✳️
[FFFFFF]@lag ✳️temcod✳️
[B][FF0000]✳️ لتوقيف لاق الفريق ✳️
[B][FF4500]/stop_lag
[B][FF0000]★☆★☆★☆★☆★☆★☆"""
                            ...
                            whitelist_cmnd = """[C][B][FFFF00]✳️ بعض الاوامر قد تكون غير شغالة في هذا وقتك ✳️
[00FFFF]✳️ السورس قديم وتم تحسينه من قبلي وفي الوقت الحالي كل الاوامر شغالة و تم اصلاحها وربطها بـالايبي الجيد ✳️
[00FFFF]✳️ للتواصل كل منصاتي يوزري هو ✳️
[B][C][00FFFF]@Shadow Adam
[FFFF00]★☆★☆★☆★☆★☆★"""
                            ...
                            last ="""[B][C][00FFFF]★☆★☆★☆★☆★☆★☆
[FFFF00]✳️ صفحة معلومات الصانع ✳️
[00FFFF]★☆★☆★☆★☆★☆★☆
[00FFFF]✳️ المبرمج ✳️[FFFFFF]⚔️ هندي comeantary ⚔️
[00FFFF]✳️⚠️  ومجاني للجميع ⚠️✳️
[00FFFF]✳️ يويتوب ✳️[FFFF00]@Najmi_FF_Experiment
[00FFFF]هذا بوت تم صنعه شخص هندي 
[FF0000]★☆★☆★☆★☆★☆★☆"""
...
async def MaiiiinE():
    ...
    if not credentials:
        ...
        print("📝 Format: uid=YOUR_PASSOWD,password=YOUR_PASSOWD")
        return None
    ...
    os.system('clear')
    print("=" * 50)
    print("ADEM comeantary BOT ~ INITIALIZING")
    print("=" * 50)
    ...
    os.system('clear')
    print("ADEM comeantary BOT ~ STARTING")
    print("=" * 50)
    ...
    os.system('clear')
    print("🤖FIRE JISAN 2.0 - CONNECTING")
    print("=" * 50)
    print("┌────────────────────────────────────┐")
    print("│ ██████████████████████████████████ │")
    print("└────────────────────────────────────┘")
    ...
    os.system('clear')
    print("=" * 50)
    print("ADEM comeantary BOT ~ ONLINE")
    print("=" * 50)
    print(f"🔹 UID: {TarGeT}")
